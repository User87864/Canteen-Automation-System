...
<html>
  ...
  <head>
    <title> About | VITAP-Canteen </title>
  </head>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top navigation-clean-search" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">VITAP-Canteen</a>
        </div>
...
?>
    ...
    <div class="wide">
        ...
        <div class="tagline">From quick bites between classes to full meals, the cafeteria serves a wide array of good and hygienic food to all the members. </div>
        <h3 style="color: red">About the food culture in VITAP-Canteen</h3>
        <br>
